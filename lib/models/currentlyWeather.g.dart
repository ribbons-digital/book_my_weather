...
part of 'currentlyWeather.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class CurrentlyWeatherAdapter extends TypeAdapter<CurrentlyWeather> {
  @override
  final typeId = 5;

  @override
  CurrentlyWeather read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, CurrentlyWeather obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.time)
